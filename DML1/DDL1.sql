...
identified by kgzuniga; --contrase�a
...
--1. Crear una funci�n que reciba como par�metro de entrada el nombre del departamento (Ejemplo �Sales�) y calcule el salario promedio del departamento. 
--La funci�n deber� devolver un mensaje como el siguiente: �El departamento Sales tiene un salario promedio de 8955� 
...
--2.Crear una funci�n que recibir� como par�metro el C�digo del empleado y retornara un valor Boolean deber� comprobar, la existencia de historia de un empleado en la tabla Job_History. 
--La funci�n devolver� TRUE si encuentra registros en la tabla y FALSE si no encuentra registros.
...
--3. Crear una funci�n que reciba como par�metro el Employee_id, y retorne la cantidad de subordinados o personal a cargo que este tiene (El campo manager_id indica el jefe de cada empleado)
...
--4. Crear un procedimiento para insertar registros en la tabla  Employees,  recibir� como par�metros todos los campos existentes. 
--Deber� controlar por medio de excepci�n si el Employee_id ya existe en la tabla de empleados y desplegar mensaje indic�ndolo. 
